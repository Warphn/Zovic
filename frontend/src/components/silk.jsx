...
if (uLightMode > 0.5) {
  ...
  vec3 shadowColor = mix(bodyColor, uColor * 0.72, uShadowOpacity);
...
const Silk = ({
  ...
  useEffect(() => {
    ...
    uniforms.uShadowOpacity.value = shadowOpacity;
  }, [speed, scale, noiseIntensity, color, rotation, lightMode, shadowOpacity, uniforms]);
